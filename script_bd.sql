...
CREATE TABLE Usuarios (
    ...
    PasswordHash NVARCHAR(MAX), -- Contraseña cifrada
...
CREATE TABLE Gastos (
    ...
    Fecha DATE NOT NULL,           -- Fecha en la que se realizó el gasto
...
CREATE TABLE Presupuestos (
    ...
    FechaInicio DATE NOT NULL,     -- Fecha de inicio del presupuesto
    FechaFin DATE NOT NULL,        -- Fecha de finalización del presupuesto
